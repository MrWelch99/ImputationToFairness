...
def make_binary_table():
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_oversample_then_imputation_numerical.csv",index=False)
...
def make_continuous_table():
    ...
    df = finalDF.to_csv("results/Processed/Continuous_table_oversample_then_imputation_numerical.csv",index=False)
...
def analyse_parameter_binary(metric_lst,df_temp,row):
    ...
    for metric in metric_lst:
        ...
        #Count ones
        trash, count = np.unique(values,return_counts=True)
        if len(count)!=1:
            num_of_1 = count[1]
        else:
            num_of_1 =0
        
        #Calculate Freq of ones
        freq_of_1 = num_of_1/len(values)
...
def analyse_table():
    ...
    df =  pandas.read_csv("results/Processed/Binary_table_oversample_then_imputation_numerical.csv")
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_oversample_then_imputation_processed.csv",index=False)
...
def analyse_table_pairwise():
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_pairwise_oversample_then_imputation_processed.csv",index=False)
...
def analyse_table_three_pairs():
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_three_pairs_oversample_then_imputation_processed.csv",index=False)
...
def analyse_continuous_table():
    ...
    df =  pandas.read_csv("results/Processed/Continuous_table_oversample_then_imputation_numerical.csv")
    ...
    df = finalDF.to_csv("results/Processed/Continuous_table_oversample_then_imputation_processed.csv",index=False)
...
def analyse_table_pairwise_continuous():
    ...
    df = finalDF.to_csv("results/Processed/Continuous_table_pairwise_oversample_then_imputation_processed.csv",index=False)
...
def analyse_table_three_pairs_continuous():
    ...
    df = finalDF.to_csv("results/Processed/Continuous_table_three_pairs_oversample_then_imputation_processed.csv",index=False)
