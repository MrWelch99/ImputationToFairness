...
from metrics.utils import calc_prob_class_given_sensitive
...
class DIAvgAll(Metric):
    ...
    def calc(self, actual, predicted, prob_predictions, dict_of_sensitive_lists, single_sensitive_name,
        ...
        single_unprotected = [val for val in sensitive_values if val in unprotected_vals][0] # - > this. Index out of range
