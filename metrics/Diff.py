...
class Diff(Metric):
     ...
     def calc(self, actual, predicted, prob_predictions, dict_of_sensitive_lists, single_sensitive_name,
          ...
          m1 = self.metric1.calc(actual, predicted, prob_predictions, dict_of_sensitive_lists, single_sensitive_name,
                                 unprotected_vals, positive_pred)
          m2 = self.metric2.calc(actual, predicted, prob_predictions, dict_of_sensitive_lists,
          ...
          diff = m1 - m2
          #print(self.name)
          #print(self.metric1.get_name()+" "+str(m1))
          #print(self.metric2.get_name()+" "+str(m2)+"\n")
          return 1.0 - diff
