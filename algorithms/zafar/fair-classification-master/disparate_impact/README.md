...
The "gamma" variable controls how much loss in accuracy we are willing to take while optimizing for  A larger value of gamma will result in more fair system, but we will be getting a more loss in accuracy.
