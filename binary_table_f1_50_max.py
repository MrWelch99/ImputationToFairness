...
def make_binary_table_max():
    ...
    sensitive_dict = {"ricci":"Race", "german":"age", "student-por":"age","student-mat":"age"}
    ...
    for dataset in DATASETS:
        ...
        for sensitive in sensitive_lst:
            ...
            if sensitive != sensitive_dict[dataset_name]:
                continue
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_oversample_then_imputation_f1_50_max.csv",index=False)
...
def analyse_table_max():
    ...
    df =  pandas.read_csv("results/Processed/Binary_table_oversample_then_imputation_f1_50_max.csv")
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_oversample_then_imputation_processed_f1_50_max.csv",index=False)
...
def analyse_table_pairwise_max():
    folder = "results/Processed/"
    missing_rates_lst = [0.05,0.1,0.2,0.4]
    missing_mechanism_lst =  ["mar","mnar","true_mcar"]
    imputation_method_lst = ["mean","knn","mice"]
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_pairwise_oversample_then_imputation_processed_f1_50_max.csv",index=False)

def analyse_table_three_pairs_max():
    folder = "results/Processed/"
    missing_rates_lst = [0.05,0.1,0.2,0.4]
    missing_mechanism_lst =  ["mar","mnar","true_mcar"]
    imputation_method_lst = ["mean","knn","mice"]
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_three_pairs_oversample_then_imputation_processed_f1_50_max.csv",index=False)
...
def main():
    make_binary_table_max()
    #make_continuous_table()

    analyse_table_max()
    analyse_table_pairwise_max()
    analyse_table_three_pairs_max()
