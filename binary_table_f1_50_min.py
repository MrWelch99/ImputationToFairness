...
def make_binary_table_min():
    ...
    sensitive_dict = {"ricci":"Race", "german":"sex", "student-por":"sex","student-mat":"sex"}
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_oversample_then_imputation_f1_50_min.csv",index=False)
...
def analyse_table_min():
    ...
    df =  pandas.read_csv("results/Processed/Binary_table_oversample_then_imputation_f1_50_min.csv")
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_oversample_then_imputation_processed_f1_50_min.csv",index=False)
...
def analyse_table_pairwise_min():
    folder = "results/Processed/"
    missing_rates_lst = [0.05,0.1,0.2,0.4]
    missing_mechanism_lst =  ["mar","mnar","true_mcar"]
    imputation_method_lst = ["mean","knn","mice"]
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_pairwise_oversample_then_imputation_processed_f1_50_min.csv",index=False)

def analyse_table_three_pairs_min():
    folder = "results/Processed/"
    missing_rates_lst = [0.05,0.1,0.2,0.4]
    missing_mechanism_lst =  ["mar","mnar","true_mcar"]
    imputation_method_lst = ["mean","knn","mice"]
    ...
    df = finalDF.to_csv("results/Processed/Binary_table_three_pairs_oversample_then_imputation_processed_f1_50_min.csv",index=False)
...
def main():
    make_binary_table_min()
    #make_continuous_table()

    analyse_table_min()
    analyse_table_pairwise_min()
    analyse_table_three_pairs_min()
